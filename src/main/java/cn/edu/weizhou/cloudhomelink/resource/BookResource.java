package cn.edu.weizhou.cloudhomelink.resource;
...
import cn.edu.weizhou.cloudhomelink.domain.Books;
import cn.edu.weizhou.cloudhomelink.service.BookService;
...
public class BookResource {
     ...
     * <p>getBooks.</p>
     *
     * @return a {@link cn.edu.weizhou.domain.Books} object.
     */
    @GET
     ...
     * @return a {@link cn.edu.weizhou.domain.Book} object.
     */
    @Path("{bookId:[0-9]*}")
    @GET
    @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
     ...
     * <p>saveBook.</p>
     *
     * @param book a {@link cn.edu.weizhou.domain.Book} object.
     * @return a {@link cn.edu.weizhou.domain.Book} object.
     */
    @POST
    @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
